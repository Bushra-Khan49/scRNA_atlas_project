...
* **CD3D:** `avg_log2FC = 3.79`, `p_val = 0`, `pct.1 = 0.886`
* **IL7R:** `avg_log2FC = 3.27`, `p_val = 0`, `pct.1 = 0.636`
* **CD2:** `avg_log2FC = 3.05`, `p_val = 0`, `pct.1 = 0.519`
* **LCK:** `avg_log2FC = 2.20`, `p_val = 0`, `pct.1 = 0.561`

### Biological Interpretation
As established, CD3D is the structural core of the T cell receptor. However, the genes immediately following it provide a massive amount of biological context:
...
2. **CD2:** This is a classic T cell surface antigen that mediates physical adhesion between T cells and other cell types (like antigen-presenting cells). Its strong presence confirms the cells are mature and capable of immune synapse formation.
3. **LCK:** This gene encodes a tyrosine kinase that sits directly inside the cell membrane. The moment a T cell recognizes an infection, LCK fires off the internal alarm. Seeing this gene highly expressed confirms that the internal signaling machinery of these T cells is fully intact.
